        ...
        switch (schemeField.id) {
          ...
          case 5: // PREFIX_SCAN
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.prefixScan = iprot.readBool();
              struct.setPrefixScanIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ScanSpec struct) throws org.apache.thrift.TException {
      ...
      if (struct.columns != null) {
        oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
        {
          ...
          for (ByteBuffer _iter37 : struct.columns)
          {
      ...
      oprot.writeBool(struct.prefixScan);
      oprot.writeFieldEnd();
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.columns = new ArrayList<ByteBuffer>(_list39.size);
          for (int _i40 = 0; _i40 < _list39.size; ++_i40)
          {
            ByteBuffer _elem41; // optional
