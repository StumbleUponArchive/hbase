...
public class ScanResult implements TBase<ScanResult, ScanResult._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final TField SCANNER_ID_FIELD_DESC = new TField("scannerId", TType.I32, (short)3);

  public List<TRowResult> results;
  ...
  static {
    ...
    tmpMap.put(_Fields.HAS_MORE, new FieldMetaData("hasMore", TFieldRequirementType.DEFAULT,
        new FieldValueMetaData(TType.BOOL)));
    tmpMap.put(_Fields.SCANNER_ID, new FieldMetaData("scannerId", TFieldRequirementType.DEFAULT,
  ...
  /** Returns true if field hasMore is set (has been asigned a value) and false otherwise */
  ...
  /** Returns true if field scannerId is set (has been asigned a value) and false otherwise */
  ...
  public int compareTo(ScanResult other) {
    ...
    if (isSetHasMore()) {
      lastComparison = TBaseHelper.compareTo(this.hasMore, typedOther.hasMore);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetScannerId()) {
      lastComparison = TBaseHelper.compareTo(this.scannerId, typedOther.scannerId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.results = new ArrayList<TRowResult>(_list9.size);
              for (int _i10 = 0; _i10 < _list9.size; ++_i10)
              {
                TRowResult _elem11;
                _elem11 = new TRowResult();
                _elem11.read(iprot);
                this.results.add(_elem11);
              }
              iprot.readListEnd();
            }
          } else {
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.results != null) {
      oprot.writeFieldBegin(RESULTS_FIELD_DESC);
      {
        ...
        for (TRowResult _iter12 : this.results)
        {
          _iter12.write(oprot);
        }
        oprot.writeListEnd();
